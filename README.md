...
## How to use
The easiest way to use SVAuth is through the “website adapter”. [**See the instruction**]( https://github.com/cs0317/SVAuth/tree/master/SVAuth/platforms). Also, welcome to [email us](mailto:shuochen@microsoft.com) if you decide to use SVAuth. We can help.  
...
Welcome to join us! [Email](mailto:shuochen@microsoft.com) the contact below . 
